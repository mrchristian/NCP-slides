...
Project objective: To enable multi-format book production for the Open Access textbook publisher 'OpenRewi'.

Nextcloud is used as a foundation for a new open-source software tool and to support the tech stack. 
