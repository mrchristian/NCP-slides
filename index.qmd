...
subtitle: "A first stage Beta open-source software development project — digital sovereign by design"
...
Project objective: To enable multi-format book production for the Open Access textbook publisher 'OpenRewi'. Nextcloud is used as a foundation for a new open-source software tool.
...
::: aside
Pipeline key: Parts - blue, and; Software - green
:::
...
::: {.column width="50%"}
Machine readable storage standard, e.g., [W3C Web Publications](https://www.w3.org/TR/wpub/)
...
Testing book files in the workflow manually to find more explore issues.
